...
<div class='panel'>
  <header>
    <h2><a href='<?php echo base_url ('admin', 'products');?>'><?php echo $parent->title;?></a> 的產品圖片列表</h2>
  ...
  <div class='content'>
    ...
    <table class='table'>
      <thead>
        <tr>
          <th width='80'>#</th>
          <th width='150' class='center'>檔案</th>
          <th >標題</th>
  ...
  <?php if ($objs) {
          foreach ($objs as $obj) { ?>
            <tr>
              ...
              <td class='center'>
                <a class='_i download' href='<?php echo $obj->name->url ();?>' download>
                  <img src='<?php echo $obj->name_icon ();?>'>
                </a>
              </td>
