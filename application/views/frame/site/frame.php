    ...
    <div id='about'>
      <div class='container'>
        ...
        <div>
          ...
          <a href='<?php echo base_url ();?>'><?php echo Lang::get ('frame', 'pages', 'index');?></a>
          <a href='<?php echo base_url ('about');?>'><?php echo Lang::get ('frame', 'pages', 'about');?></a>
          <a href='<?php echo base_url ('news-list');?>'><?php echo Lang::get ('frame', 'pages', 'news');?></a>
          <a href='<?php echo base_url ('support');?>'><?php echo Lang::get ('frame', 'pages', 'support');?></a>
          <a href='<?php echo base_url ('products');?>'><?php echo Lang::get ('frame', 'pages', 'product');?></a>
          <a href='<?php echo base_url ('partners');?>'><?php echo Lang::get ('frame', 'pages', 'partner');?></a>
        </div>
        <div>
